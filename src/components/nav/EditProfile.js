...
export default function EditProfile() {
  const { setProfileEdit, userName, setUserName, defaultTheme } = useStateContext();
  ...
  return (
    <div className={`profileEditCon ${saved && "fadeOutProfileEdit"}`}>
      ...
      <form className="profileEdit" onSubmit={(e) => handleSubmit(e)} style={{background: defaultTheme[1]}}>
        <div className="profileImg">
          ...
          <button type='button' className="profileImgEdit" style={{background: defaultTheme[3],color:defaultTheme[2]}}>
            <Edit />
          </button>
        </div>
        <input
        ...
        <div className="buttonCon">
          <button style={{background: defaultTheme[3],color:defaultTheme[2]}} onClick={handleClose}>Cancel</button>
          <button style={{background: defaultTheme[3],color:defaultTheme[2]}} type='submit'>Save</button>
        </div>
      </form>
    </div>
  );
